...
GRIDCRO2D=${MCIP_OUTDIR}/GRIDCRO2D_2022-${month}-${days}
METCRO3D=$METDIR/METCRO3D_2022-${month}-${days}
METDOT3D=$METDIR/METDOT3D_2022-${month}-${days}
METCRO2D=$METDIR/METCRO2D_2022-${month}-${days}

MODIS=./data/2022/fire_archive_M-C61_2022-${month}.csv
VIIRS=./data/2022/fire_archive_SV-C2_2022-${month}.csv
...
OUTFILE=./SEA.${domain}.SAPRC07T.fire3d.${month}${days}2022.txt
